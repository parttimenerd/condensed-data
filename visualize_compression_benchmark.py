...
Creates bar plots showing duration and size relative to a baseline (default: LZ4).
"""
...
def create_relative_plots(aggregated, baseline='LZ4', output_prefix='compression_benchmark'):
