...
public record Configuration(
    ...
    /**
     * GC-log equivalent — enable only GC events (matches the bundled gc-monitoring.jfc /
     * gc-analysis.jfc recording configs). No allocation profiling, no execution samples. Use with
     * {@code --config gc-log}.
     */
